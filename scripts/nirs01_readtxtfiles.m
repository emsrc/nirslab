% readtxtfiles: 12/2012 (MvB)
%--------------------------------------------------------------------------
% Reads nirsO and nirsP textfiles and processes subject data (subj_data)  
%--------------------------------------------------------------------------


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% The result is a mat-file containing:
%   - all raw nirs data (nirsO, nirsO_od, nirsP, nirsP_od)
%   - normalized & synchronized data (nirsO, nirsP)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

warning on;

%% Define subjects, periods and days
...
% start and end of tes  t markers
start_marker = 'i';
end_marker = 'j';
...
%% Read nirsO and nirsP files

for s = 25:25       % use this for reading part of the subjects
%for s = 1:subjects
    % -------------------------------------------------------------
    % 1. read in nirs data
    % -------------------------------------------------------------
